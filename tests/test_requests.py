...
class RequestTest(unittest.TestCase):
    ...
    def test_urls(self):
        ...
        self.assertEqual(
            request._full_url("seismicity/"),
            "https://bma.cendana15.com/api/v1/seismicity/",
        )
        self.assertEqual(
            request._full_query_with_params(params), "?eventdate__gte=2020-01-01"
        )
        self.assertEqual(
            request._full_url_with_params("seismicity/", params),
            "https://bma.cendana15.com/api/v1/seismicity/" "?eventdate__gte=2020-01-01",
        )
    ...
    def test_post_body(self):
        ...
        url, method, body, headers = request.prepare_request("POST", "slope/", params)
