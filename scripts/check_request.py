...
def main():
    ...
    api.fetch_csdr(
        benchmark="BAB0", reflector="RB1", start_at="2021-01-01", end_at="2021-01-10"
    )
    ...
    api.fetch_seismicity_cluster(
        eventdate__gte="2021-02-01", eventdate__lt="2021-02-10", cluster=40
    )
